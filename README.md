...
[![Python: 3.8+](https://img.shields.io/badge/Python-3.8%2B-yellow.svg)](requirements.txt)
...
### Q: 主密码忘记了怎么办？
A: 目前需要手动删除配置文件（`config.json`、`encryption_key.key`、`encryption_salt.key`）来重置，但请注意：删除后所有已加密的配置信息将无法恢复。
