...
class TestCreateWifiProfile:
    ...
    def test_contains_ssid_and_password(self) -> None:
...
class TestWifiProfileExists:
    ...
    def test_profile_not_exists(self) -> None:
...
class TestDoConnectWifi:
    ...
    def test_connect_with_existing_profile(self) -> None:
    ...
    def test_connect_creates_new_profile(self) -> None:
    ...
    def test_connect_profile_error(self) -> None:
    ...
    def test_connect_cleanup_on_error(self) -> None:
...
class TestConnectWifi:
    ...
    def test_connect_profile_error_returns_false(self) -> None:
    ...
    def test_connect_connection_error_returns_false(self) -> None:
...
class TestAutoConnectWifi:
    ...
    def test_connects_on_first_try(self) -> None:
    ...
    def test_retries_until_max(self) -> None:
    ...
    def test_uses_config_snapshot_when_none(self) -> None:
    ...
    def test_cancelled_before_first_attempt(self) -> None:
    ...
    def test_cancelled_during_backoff_sleep(self) -> None:
        """退避睡眠期间取消时提前退出（回归 C4）"""
        cfg = {
            "WIFI_NAME": "MyWiFi",
            "WIFI_PASSWORD": "pass",
    ...
    def test_empty_wifi_name_skips_retry_loop(self) -> None:
